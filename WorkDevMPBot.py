...
from strategies.test_strategies.check_mp import check_mp_strategy_LSC
from strategies.work_strategies.HelpTA import get_rws
from strategies.pos_mult_wss.MP_LTA1 import MP_LTA_SHCHI as WS
...
trades,equity,equity_fee,longs,shorts,closes= check_mp_strategy_LSC(df.copy(),bot,fee_base,close_2330=close_2330)
